...
class ImageBlockTest extends Bootstrap3BlockTestCase
{
    ...
    {
        $this->block->addExtraVar('image', ['source' => 'luya.jpg', 'caption' => null]);
    ...
    public function testCaptionFromImage()
    {
        $this->block->addExtraVar('image', ['source' => 'luya.jpg', 'caption' => 'cap']);
        $this->assertSame('<div class="image"><figure><img class="img-responsive" src="luya.jpg" alt="cap" title="cap"></figure></div>', $this->renderFrontendNoSpace());
    }
