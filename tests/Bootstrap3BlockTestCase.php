...
namespace luya\bootstrap3\tests;

use luya\testsuite\cases\CmsBlockTestCase;

abstract class Bootstrap3BlockTestCase extends CmsBlockTestCase
{
    public function getConfigArray()
    {
        return [
            ...
            'modules' => [
                'CmsUnitModule' => 'luya\bootstrap3\tests\data\modules\CmsUnitModule',
            ]
        ];
    }
